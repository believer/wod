...
describe("#workoutType", () => {
  ...
  testAll("handles non-EMOM", list{ #AMRAP, #ForTime }, value =>
  ...
  testAll("handles non-AMRAP", list{#AltEMOM(0), #EMOM(0), #ForTime}, value =>
  ...
  testAll("handles non-AMRAP", list{ #AltEMOM(0), #EMOM(0), #AMRAP }, value =>
...
describe("#category", () => {
  ...
  testAll("handles non-WZA", list{ #Open(0), #Girl, #Hero }, value =>
  ...
  testAll("handles non-Open", list{ #Wodapalooza(0), #Girl, #Hero }, value =>
  ...
  testAll("handles non-Girl", list{ #Wodapalooza(0), #Open(0), #Hero }, value =>
  ...
  testAll("handles non-Hero", list{ #Wodapalooza(0), #Open(0), #Girl }, value =>
