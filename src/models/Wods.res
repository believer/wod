...
_Amanda_ is one of the classic CrossFit "Girl" workouts, but not one of the
  ...
  Wod.make(
    ...
    ~description=
      Some((
        Some(
          j`_Cindy_, typically thought of as one of CrossFit's classic "Girls" workouts, has been around since 2005, but was not actually not named as one of "The Girls" in a 2010 CrossFit Journal article. Despite that, it remains one of the most popular CrossFit workouts.`,
        ),
        None,
      )),
    ~timeCap=Some(20),
...
Complete as many rounds as possible in 3 minutes, then rest 1 minute. Start each 3-minute cycle where you left off on the previous cycle. Repeat for a total of 5 cycles. Count total rounds and reps completed.
  ...
  Wod.make(
    ...
    ~description=
      Some((
        Some(
          j`Solid rack and firmly planted feet in jerk dip squat, which is basically a shallow front squat. Split jerk is with focus on timing and precision.`,
        ),
        None,
      )),
    ~wodType=#E90(12),
